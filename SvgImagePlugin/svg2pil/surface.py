...
#        parent_width=None, parent_height=None,
        ...
        instance = cls(
            tree, dpi,
#            None, parent_width, parent_height,
            scale,
    ...
    def __init__(self, tree, dpi,

#        parent_surface=None, parent_width=None, parent_height=None,
        ...
        """
        self.cairo = None
        self.context_width, self.context_height = None, None  #parent_width, parent_height
...
class ImageSurface(Surface):
    """A surface that writes to PIl image."""
    ...
    def finish(self):
        """Read the surface content."""
        format = self.cairo.get_format()
        size = (self.cairo.get_width(), self.cairo.get_height())
        stride = self.cairo.get_stride()
        with self.cairo.get_data() as memory:
